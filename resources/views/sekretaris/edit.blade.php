    ...
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Data Sekretaris</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="{{ route('sekretaris.update' , $sekretaris->id) }}" method="POST">
            @method('PUT')
            @csrf
            <div class="box-body">
            ...
            <div class="form-group">
              ...
              <a href="{{ route('sekretaris.index') }}" class="btn btn-danger">Kembali</a>
            </div>
          </form>
        </div>
      </div>
