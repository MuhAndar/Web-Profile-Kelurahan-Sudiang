    ...
    <div class="col-md-8">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Data Kepala Seksi Pemerintahan</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="{{ route('pemerintahan.update' , $pemerintahan->id) }}" method="POST">
            @method('PUT')
            @csrf
            <div class="box-body">
            <div class="form-group">
              <label for="exampleInputEmail1">Text 1</label>
              <input type="text" class="form-control" name="text1" placeholder="Text 1"  value="{{ $pemerintahan->text1 }}">
            </div>
            <div class="form-group">
